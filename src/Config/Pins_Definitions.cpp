...
const int WOOD_FEED_MOTOR_STEP_PIN = 17;   // Step pulse signal for wood feeding motor (pushes wood forward for angled cuts)
const int WOOD_FEED_MOTOR_DIR_PIN = 18;    // Direction control for wood feeding motor
...
const int WOOD_FEED_MOTOR_HOME_SWITCH = 16;
...
const int WOOD_FEED_CLAMP_RELAY = 36;      // Clamps wood during feed positioning
const int WOOD_SECURE_CLAMP_RELAY = 48;    // Secures wood during cutting
const int CATCHER_CLAMP_RELAY = 42;        // Clamps cut pieces in catcher
