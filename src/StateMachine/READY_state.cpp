...
void ReadyState::execute(StateManager& stateManager) {
...
void ReadyState::handleReloadModeLogic(StateManager& stateManager) {
...
void ReadyState::checkStartConditions(StateManager& stateManager) {
    turnGreenLedOn();
